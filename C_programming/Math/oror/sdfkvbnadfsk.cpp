...
int main()
{
    ...
    graph->edge[6].src = 2;
    graph->edge[6].dest = 5;
    graph->edge[6].weight = 16;

    graph->edge[7].src = 3;
    graph->edge[7].dest = 5;
    graph->edge[7].weight = 17;
    ...
    // graph->edge[12].weight = 15;

    // graph->edge[13].src = 6;
    // graph->edge[13].dest = 5;
    // graph->edge[13].weight = 19;
