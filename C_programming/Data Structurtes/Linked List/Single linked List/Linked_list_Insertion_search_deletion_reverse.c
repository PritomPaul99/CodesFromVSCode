...
void main()
{
    ...
    while (1)
    {
        ...
        default:
        {
            printf("Error...!!! Plese enter valid option....!!!");
...
void insert_at_front(int item)
{
    ...
    else
    {
        ...
        if (head == NULL)
        {
            ...
            printf("\nData inserted in the front successlly.\n");
...
void insert_at_end(int item)
{
    ...
    else
    {
        ...
        if (head == NULL)
        {
            ...
            printf("\nData inserted in the end successfully.\n");
            return;
        }
        else
        {
...
void insert_in_selected_position(int item)
{
    ...
    {
        printf("\n\tPlease, enter the position, after where you wabnt to insert the data: ");
        scanf("%d", &pos);
        temp = head;
        ptr->data = item;
        for (int i = 1; i < pos; i++)
...
void delete_from_position(void)
{
    ...
    printf("Enter the positionn after whitch you want to delete data: ");
    scanf("%d", &pos);
