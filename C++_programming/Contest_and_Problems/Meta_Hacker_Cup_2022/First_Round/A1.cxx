...
const ll Mod = 1e9 + 7;
// File handling
#define f_input freopen("consecutive_cuts_chapter_1_validation_input.txt", "r", stdin)
#define f_output freopen("consecutive_cuts_chapter_1_validation_output.txt", "w", stdout)
#define nl '\n'
